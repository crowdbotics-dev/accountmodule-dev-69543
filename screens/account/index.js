  ...
  return <View style={styles.container}>
            <ScrollView>
                <View style={styles.profileContainer}>
                    <Image source={require("./IMG-20210111-WA0046.jpg")} style={styles.profilePicture} />
                ...
                <View style={[styles.accountHeadings]}>
                    ...
                    <Text style={[styles.inputText1, styles.VbzMunhp]}>DELETE</Text>
                </View>
